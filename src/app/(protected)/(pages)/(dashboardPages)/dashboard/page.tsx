...
const DashboardPage = async () => {
  ...
  return (
    <div className="w-full flex flex-col gap-6 relative p-4 md:p-0">
      <div className="flex flex-col-reverse items-start w-full gap-6 sm:flex-row sm:justify-baseline sm:items-center">
        <div className="felx flex-col items-start">
          <h1 className="text-2xl font-semibold dark:text-primary backdrop-blur-lg">
            Projects
          </h1>
          <p className="text-base font-normal dark:text-stone-500">
